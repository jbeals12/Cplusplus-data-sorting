...
//The linked list's begin() method, returns an iterator at first
template <typename T>
...
//The linked list's end() method, returns an iterator object at last
template <typename T>
...
{
	// if iterator is offTheRightEdge
	if (this->offTheRightEdge == true)
	{
		return *this;
	}

	// if iterator is at last
	else if (this->current->forward == NULL)
	{
		this->offTheRightEdge = true;
		return *this;
	}

	// or else move iterator forward
	else
	{
...
Iterator<T> Iterator<T>::operator++(int)
{
	...
	// or else make a temp copy and
	// move original iterator forward
	else
	{
		Iterator<T> tempIter = *this;
		++(*this);
		return tempIter;
	}
}
...
Iterator<T>& Iterator<T>::operator--()
{
	...
	// if iterator is at first
	else if (this->current->backward == NULL)
	{
		return *this;
	}

	// or else move the iterator backward
	else
	{
...
// Iterator's manual reverse function
template <typename T>
